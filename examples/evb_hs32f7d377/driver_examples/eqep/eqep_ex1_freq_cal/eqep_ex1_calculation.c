 ...
 *
 * \brief This file includes the eQEP frequency calculation function called by
 ...
 ******************************************************************************/
/*!  
 * \brief FreqCal_calculate - Function to calculate the frequency of the input signal using both the unit
 * timer and the quadrature capture units.
 *
 * \details For a more detailed explanation of the calculations, read the description at
