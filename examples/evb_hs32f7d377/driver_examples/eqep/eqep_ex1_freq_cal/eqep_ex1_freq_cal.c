 ...
 *
 * \brief Frequency Measurement Using eQEP
 *
...
void initEQEP(void)
{
	...
	EQEP_SourceSelect_t source_myEQEP0 =
	{
	...
	EQEP_selectSource(EQEP1, source_myEQEP0);
	...
	EQEP_setPositionCounterConfig(EQEP1,kEQEP_POSITION_RESET_1ST_IDX,4294967295U);
