...
/*
 * 
 * \file mcan_ex5_range_filter.c
 * 
 * \brief MCAN Reception of EXTID frames (with RANGE filter) into RX-FIFO1
 * 
 ...
 *  MCAN Message RAM starts at 0x42110000, so received messages will be copied
 *  starting at address 0x421100EC. Note that as long as the ID matches,
...
static void MCANConfig(void)
{
    ...
    MCAN_ExtMsgIDFilterElement_t extFiltelem;
    ...
    MCAN_addExtMsgIDFilter((MCAN_Type *)MCAN_BASE, 0U, &extFiltelem);
